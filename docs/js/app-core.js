...
// Navigation
function navigateTo(s){document.querySelectorAll('.section').forEach(el=>el.classList.remove('active'));document.querySelectorAll('.nav-item').forEach(n=>n.classList.remove('active'));const sec=document.getElementById('section-'+s);if(sec)sec.classList.add('active');const navBtn=document.querySelector(`[data-section="${s}"]`);if(navBtn)navBtn.classList.add('active');if(s==='dashboard')loadDashboard();if(s==='admin'){initRevAdminSelectors();loadNotificacionesAdmin();if(typeof loadModulosAdmin==='function')loadModulosAdmin();if(typeof loadDiasNoHabilesAdmin==='function')loadDiasNoHabilesAdmin();}if(s==='dxh900'){loadDxH900HistorialForm()}if(s==='elim-muestras'){loadElimMuestrasHistorialForm()}if(s==='termo'){if(typeof checkDuplicateTermo==='function')checkDuplicateTermo();if(typeof loadRecentTermo==='function')loadRecentTermo();}if(s==='centrifugas'){if(typeof checkDuplicateCentrifugas==='function')checkDuplicateCentrifugas();if(typeof loadRecentCentrifugas==='function')loadRecentCentrifugas();}if(s==='mesones'){if(typeof checkDuplicateMesones==='function')checkDuplicateMesones();if(typeof loadRecentMesones==='function')loadRecentMesones();}if(s==='refri-temp'&&typeof loadRecentRefriTemp==='function')loadRecentRefriTemp();if(s==='limp-refri'&&typeof loadRecentLimpRefri==='function')loadRecentLimpRefri();if(s==='conductividad'&&typeof loadRecentConductividad==='function')loadRecentConductividad();if(s==='cobas'&&typeof loadRecentCobas==='function')loadRecentCobas();if(s==='elim-muestras'&&typeof checkDuplicateElimMuestras==='function')checkDuplicateElimMuestras();}
