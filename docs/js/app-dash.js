        ...
        <table style="width:100%; border-collapse:collapse; font-size:14px; text-align:left;">
          <thead>
            <tr style="border-bottom:2px solid var(--border-color); color:var(--text-muted-color);">
              ...
              <th style="padding:10px 8px; font-weight:600; width:60%;">Destinatarios (correos separados por coma)</th>
              <th style="padding:10px 8px; font-weight:600; text-align:center; width:20%;">Pausar</th>
            </tr>
          </thead>
          <tbody>
    `;
